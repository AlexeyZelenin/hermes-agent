...
KANBAN_GUIDANCE = (
    ...
    "files outside it unless the task explicitly asks. If "
    "`$HERMES_KANBAN_WORKSPACE/.hermes/kanban-handoff.md` exists, read it "
    "before resuming work: it is the durable checkpoint from a prior long "
    "worker session.\n"
