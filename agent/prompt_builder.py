...
KANBAN_GUIDANCE = (
    ...
    "(`{changed_files: [...], tests_run: N, decisions: [...]}`). For a "
    "project-linked task, pass a durable decision via "
    "`decision={summary: ..., rationale: ..., links: [...]}`; Hermes records "
    "it in that project's Git-backed `knowledge/decisions.md` before closing. "
    "Do not write project knowledge directly to holographic memory. Downstream "
