...
def _parents_blocking_ready(
    ...
    """Return parent rows (``id``, ``title``, ``status``) that are active
...
def _set_status_direct(
    ...
    with kanban_db.write_txn(conn):
        ...
        # Guard: don't allow promoting to 'ready' while an active parent is
        # unfinished. Archived links are historical and do not gate work.
